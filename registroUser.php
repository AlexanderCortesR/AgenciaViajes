        ...
        <div class="row">
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        <h5 class="card-title text-center">Turistik 🛫 | Registrate</h5>
                        ...
                        <form action=sesion.php method="POST" class="form-signin">
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" name="username" id="nombreUsuari" class="form-control"
                            ...
                            <input type="hidden" name="cedula" class="form-control" value="<?php echo rand(1, 1000000); ?> ">
                            <div class="form-group">
