                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Agregue datos del hotel</h5>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $row['numCiudad']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $row['nombreHotel']; ?>
                                                </td>
                                                <td>
                                                    <form action="editHotel.php" method="post">
                                                        <input type="hidden" name="edit_ciuHot"
                                                            value="<?php echo $row['numCiudad']; ?>">
                                                        <input type="hidden" name="edit_nomHot"
                                                            value="<?php echo $row['nombreHotel']; ?>">

                                                        <button type="submit" name="edit_btnHot"
                                                ...
                                                <td>
                                                    <form action="../codigo.php" method="post">
                                                        <input type="hidden" name="delete_idHot"
                                                            value="<?php echo $row['nombreHotel']; ?>">
                                                        <input type="hidden" name="delete_ciuHot"
                                                            value="<?php echo $row['numCiudad']; ?>">
                                                        <button type="submit" name="delete_btnHot"
