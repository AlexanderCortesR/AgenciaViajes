                            ...
                            <div class="modal-content">
                                ...
                                <form action="../codigo.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" name="btn_hotel" class="btn btn-primary">Guardar
                                            Usuario</button>
                                    </div>
                                </form>
                            </div>
...
if (isset($_POST['edit_btnHot'])) {
    $ciudad = $_POST['edit_ciuHot'];
    $nombre = $_POST['edit_nomHot'];

    $query = "SELECT * FROM hotel WHERE numCiudad='$ciudad' and nombreHotel='$nombre'";
...
?>
                                ...
                                <form action="../codigo.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label> Nombre de la ubicación del hotel </label>
                                        <select name="edit_numCiudad" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="edit_nomHot" value="<?php echo $row['nombreHotel'] ?>"
                                            class="form-control">
                                    </div>

                                    <a href="registrarHotel.php" class="btn btn-danger">Cancelar</a>
                                    <button type="submit" name="updatebtnHotel" class="btn btn-success"> Actualizar
                                    </button>
                                </form>
                                <?php
    }
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        All rights reserved Turistik 🛫 | The Project made <i class="icon-heart" aria-hidden="true"></i>
                        by <a target="_blank">MAVA</a>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
