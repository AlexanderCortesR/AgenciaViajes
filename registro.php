                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                            ...
                            <div class="bg-black py-2 collapse-inner rounded">
                                <a class="collapse-item active" href="registro.php" role="tab" aria-controls="v-pills-home"
                        aria-selected="true"><strong> - Reservar Boleto de Avión 🛫</strong></a><br>
                                ...
                                <div class="form-row">                                    
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="nombre_origen"  class="form-control" required>
                                            ...
                                            ?>
                                                    <option required value="<?php echo $valorOrigen['nombreOrigen'] ?>" > <?php echo $valorOrigen['nombreOrigen'] ?> </option>
                                            <?php
                                                }
                                            ?>
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="nombre_destino" class="form-control" required>
                                            ...
                                            ?>
                                                    <option required value="<?php echo $valorDestino['nombreDestino'] ?>" > <?php echo $valorDestino['nombreDestino'] ?> </option>
                                            <?php
                                                }
                                            ?>
                                        </select>
                                    ...
                                    <div class="form-group col-md-6 ">
                                        <label>Hora de salida</label>
                                        <input type="text" name="hora_reg" class="form-control" id="timepicker"
                                            placeholder="Seleccione Hora" required>
                                    </div>
